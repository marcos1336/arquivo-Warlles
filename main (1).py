...
def mostrar_tabela(nome_setor, campos, dados):
    ...
    print(f"\n{'='*140}")
    print(f" TABELA: {nome_setor.upper()} ".center(140, " "))
    print(f"{'='*140}")
...
def gerenciar_setor(opcao_setor):
    ...
    while True:
        ...
        if op == "1":
            ...
            id_busca = input("Digite o ID para alterar: ")
            ...
            for idx, linha in enumerate(dados):
                ...
                if linha[0] == id_busca:
                    ...
                    for i, campo in enumerate(campos):
                        ...
                        valor = input(
                            f"Novo {campo} (Enter mantém '{dados[idx][i]}'): "
                        )
            ...
            id_busca = input("Digite o ID para excluir: ")
...
while True:
    ...
    print("╔════════════════════════════════════════════════════════════════════╗")
    print("║        MUNDÃO DO 10 - SHOPPING DE VARIEDADES                     ║")
    print("╚════════════════════════════════════════════════════════════════════╝")
    ...
    if escolha in SETORES:
        ...
        print("\nFinalizando sistema do MUNDÃO DO 10 - SHOPPING DE VARIEDADES...")
